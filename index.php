...
<dl class="edgeToEdge formFields">
  ...
  <dd>
    ...
    <dd><textarea cols="20" rows="10" name="elements">Work with vendors and oversee the production of design elements, such as printed materials, attire elements, and décor details.</textarea>
    </dd>
    
    <dt><label for="avenues">Avenues/Methods</label></dt>
    <dd><textarea cols="20" rows="10" name="avenues">Suggest avenues and methods that will...</textarea>
    </dd>
    ...
    dict_field('pmt_date_1','Payment Date 1:');
    dict_field('pmt_date_2','Payment Date 2:');
    dict_field('pmt_date_3','Payment Date 3:');
    dict_field('num_people','Number Guests:');
    dict_field('num_locations','Number Locations:');
    dict_field('option_date','Option Date:');
