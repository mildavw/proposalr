...
text += "«phone»\n";
text += "«email»";
content['address'] = {sort:1, text:text};
...
content['Fees, Billing, and Travel'] = {sort:10, text:text};
...
content['fine_print'] = {sort:11, text:text};
...
content['salutation'] = {sort:12, text:text};

content['signature_line'] = {sort:13, text:"«bride_first» «bride_last»\nor «groom_first» «groom_last»"};