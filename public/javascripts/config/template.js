...
config.template.push({title:'Vendor Selection and Budget Management', text:"Source and suggest all vendors such as: «vendorsuggestions». Narrow vendor recommendations to those within the design criteria and budget parameters. Schedule and attend initial vendor appointments as needed. Suggest avenues and methods that will save money and add value. Assist client in executing contracts and delivering deposits if necessary."});

config.template.push({title:'Vendor Maintenance and Production Management', text:"Act as liaison to vendors and contractors. Communicate design expectations. «design_elements» Communicate planning and payment deadlines. Communicate directions, load-in schedule, setup requirements, and load-out procedure. «avenues_methods» Schedule and attend follow-up vendor appointments as needed. Write Event Plan, including:  wedding day contact sheet, timeline, and setup narrative, for approval by «bride_first» and «groom_first». Once approved, distribute to all vendors and requested parties. Conduct final vendor confirmations, with at least one final walkthrough and additional ones as necessary."});
...
text += "<li>$«payment_amount» each due on «payment_date_2» «payment_date_3» «payment_date_4»</li>";
text += "</ul>";
...
text += "\n";
text += "This proposal is based on consultation and coordination for a wedding of approximately «number_guests» people, involving «number_locations» location(s). Should the aforementioned numbers or tasks increase, affecting the staff necessary for your event, additional fees shall apply at the overtime rate of $75/hour. Labor (e.g., setup/teardown/janitorial), production, and raw materials are not included in the stated fees. A 5% processing fee may be added to vendor payments or materials reimbursements paid with a credit card, to cover transaction fees incurred by EJP Events.";
