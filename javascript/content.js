...
text += "• $«due_upon_signing» upon signature of this letter;";
text += "• $«payment_amount» each due on «payment_date_1», «payment_date_2», and «payment_date_3».";
text += "\n";
...
content['Fees, Billing, and Travel'] = text;
...
content['signature_line'] = "«bride_first» «bride_last»\nor «groom_first» «groom_last»";