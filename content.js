...
var text = "«BridesFirstName» «BridesLastName»\n";
text += "and «GroomsFirstName» «GroomsLastName»\n";
text += "«Address1»\n";
...
content['The Wedding Day'] = "Provide Lead Coordinator and «Assistants» Assistant(s). Install and arrange simple design elements such as guest book table, favors, place cards, etc (items provided by Client). Oversee vendors’ installation and delivery of all other design elements such as tents, lighting, infrastructure, arches or canopies, aisle and altar décor, floral arrangements, tablescape, and other custom-built items. Attend to bride and groom’s needs during the getting-ready period. Coordinate photography schedule. Direct the wedding ceremony. Move small items from ceremony to reception site. Ensure all vendors provide according to contract. Oversee the Event Plan and reception timeline.";
...
text += "\n";
text += "For our work, we will charge a flat fee of $«FlatFeeNO», as follows:";
text += "• $«AmtUponSigNO» upon signature of this letter;";
text += "• $«QtlyPayment» each due on «PmtDate1», «PmtDate2», and «PmtDate3».";
text += "\n";
...
content['signature_line'] = "«BridesFirstName» «BridesLastName»\nor «GroomsFirstName» «GroomsLastName»";