...
content['The Wedding Day'] = "Provide Lead Coordinator and «num_assistants» Assistant(s). Install and arrange simple design elements such as guest book table, favors, place cards, etc (items provided by Client). Oversee vendors’ installation and delivery of all other design elements such as «oversee». Attend to bride and groom’s needs during the getting-ready period. Coordinate photography schedule. Direct the wedding ceremony. Move small items from ceremony to reception site. Ensure all vendors provide according to contract. Oversee the Event Plan and reception timeline.";
...
text += "• $«due_on_sign» upon signature of this letter;";
text += "• $«qrtly_payment» each due on «pmt_date_1», «pmt_date_2», and «pmt_date_3».";
text += "\n";
